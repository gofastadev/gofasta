...
### As a Library
```bash
go get github.com/healtronlabs/gofasta/packages/transpiler
```

### As a CLI Tool
```bash
go install github.com/healtronlabs/gofasta/packages/transpiler/cmd/gofasta-transpiler@latest
```
...
RUN go install github.com/healtronlabs/gofasta/packages/transpiler/cmd/gofasta-transpiler@latest
COPY src/ /app/src/
WORKDIR /app
